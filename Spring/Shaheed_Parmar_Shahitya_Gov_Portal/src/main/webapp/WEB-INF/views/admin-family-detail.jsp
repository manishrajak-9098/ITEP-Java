      ...
      <% if(doc != null) { %>
        <div style="display:flex; gap:12px; flex-wrap:wrap;">
            ...
            <div class="p-16 border rounded text-center" style="flex:1; min-width:180px;">
                ...
                <a href="${pageContext.request.contextPath}/uploads/<%= doc.getAadhaarPath() %>" target="_blank" class="btn btn-outline btn-xs">View Document</a>
            </div>
            <!-- 2. Army ID -->
            <div class="p-16 border rounded text-center" style="flex:1; min-width:180px;">
                <p class="text-xs muted">Army ID Card</p>
                <a href="${pageContext.request.contextPath}/uploads/<%= doc.getArmyIdPath() %>" target="_blank" class="btn btn-outline btn-xs">View Document</a>
            </div>
            <!-- 3. Martyrdom Certificate -->
            <div class="p-16 border rounded text-center" style="flex:1; min-width:180px;">
                <p class="text-xs muted">Martyrdom Cert.</p>
                <a href="${pageContext.request.contextPath}/uploads/<%= doc.getCertificatePath() %>" target="_blank" class="btn btn-outline btn-xs">View Document</a>
            </div>
            <!-- 4. Family Relationship Proof -->
            <div class="p-16 border rounded text-center" style="flex:1; min-width:180px;">
                <p class="text-xs muted">Family Proof</p>
                <a href="${pageContext.request.contextPath}/uploads/<%= doc.getFamilyProofPath() %>" target="_blank" class="btn btn-outline btn-xs">View Document</a>
            </div>
            <!-- 5. Shaheed Photo -->
            <div class="p-16 border rounded text-center" style="flex:1; min-width:180px;">
                <p class="text-xs muted">Shaheed Photo</p>
                <a href="${pageContext.request.contextPath}/uploads/<%= doc.getShaheedPhotoPath() %>" target="_blank" class="btn btn-outline btn-xs">View Photo</a>
            </div>
        </div>
      <% } else { %>
